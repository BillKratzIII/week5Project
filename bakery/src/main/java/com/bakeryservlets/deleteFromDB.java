...
public class deleteFromDB extends HttpServlet {
	 ...
	 *      response)
	 */
	// method to take input from deleteItem.jsp and delete from SQL database
	// using the DAO.deleteFromDB() method
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		BakeryItem itemToDelete = new BakeryItem();

		itemToDelete.setProductID(request.getParameter("productID"));

		DAO.deleteFromDB(itemToDelete);
